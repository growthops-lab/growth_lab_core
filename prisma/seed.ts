...
const defaultSettings = {
  ...
  BLOCK_AFFILIATE_DIRECT_LINKS: process.env.BLOCK_AFFILIATE_DIRECT_LINKS ?? "true",
  ...
  WORDPRESS_REQUEST_TIMEOUT_MS: process.env.WORDPRESS_REQUEST_TIMEOUT_MS ?? "15000",
  WORDPRESS_ALLOWED_STATUSES: process.env.WORDPRESS_ALLOWED_STATUSES ?? "draft,pending,private,publish",
  ...
  WORDPRESS_REQUIRE_CONFIRM_FOR_PUBLISH: process.env.WORDPRESS_REQUIRE_CONFIRM_FOR_PUBLISH ?? "true",
  WORDPRESS_REQUIRE_CONFIRM_FOR_PUBLISHED_UPDATE:
    process.env.WORDPRESS_REQUIRE_CONFIRM_FOR_PUBLISHED_UPDATE ?? "true",
  WORDPRESS_AUTO_ADD_ALLOWED_DOMAIN: process.env.WORDPRESS_AUTO_ADD_ALLOWED_DOMAIN ?? "true",
  ...
  IMAGE_STORAGE_DIR: process.env.IMAGE_STORAGE_DIR ?? "./public/generated-images",
  IMAGE_PUBLIC_BASE_URL: process.env.IMAGE_PUBLIC_BASE_URL ?? "/generated-images",
  IMAGE_MOCK_MODE: process.env.IMAGE_MOCK_MODE ?? "true",
  IMAGE_MAX_FILE_SIZE_MB: process.env.IMAGE_MAX_FILE_SIZE_MB ?? "10",
  WORDPRESS_ENABLE_MEDIA_UPLOAD: process.env.WORDPRESS_ENABLE_MEDIA_UPLOAD ?? "false",
  WORDPRESS_MEDIA_MOCK_MODE: process.env.WORDPRESS_MEDIA_MOCK_MODE ?? "true",
  WORDPRESS_FEATURED_MEDIA_UPDATE_ENABLED: process.env.WORDPRESS_FEATURED_MEDIA_UPDATE_ENABLED ?? "false",
  ...
  AFFILIATE_CSV_IMPORT_ENABLED: process.env.AFFILIATE_CSV_IMPORT_ENABLED ?? "true",
  AFFILIATE_SCRAPING_ENABLED: process.env.AFFILIATE_SCRAPING_ENABLED ?? "false",
  AFFILIATE_DIRECT_X_LINK_BLOCK: process.env.AFFILIATE_DIRECT_X_LINK_BLOCK ?? "true",
  ...
  GROWTH_SCORE_DEFAULT_PERIOD_DAYS: process.env.GROWTH_SCORE_DEFAULT_PERIOD_DAYS ?? "30",
  GROWTH_SCORE_MIN_DATA_DAYS: process.env.GROWTH_SCORE_MIN_DATA_DAYS ?? "7",
  GROWTH_SCORE_REQUIRE_HUMAN_REVIEW: process.env.GROWTH_SCORE_REQUIRE_HUMAN_REVIEW ?? "true",
  ...
  GOOGLE_SEARCH_CONSOLE_MOCK_MODE: process.env.GOOGLE_SEARCH_CONSOLE_MOCK_MODE ?? "true",
  GOOGLE_SEARCH_CONSOLE_API_ENABLED: process.env.GOOGLE_SEARCH_CONSOLE_API_ENABLED ?? "false",
  GOOGLE_SEARCH_CONSOLE_CSV_IMPORT_ENABLED: process.env.GOOGLE_SEARCH_CONSOLE_CSV_IMPORT_ENABLED ?? "true",
  GOOGLE_SEARCH_CONSOLE_REQUEST_TIMEOUT_MS: process.env.GOOGLE_SEARCH_CONSOLE_REQUEST_TIMEOUT_MS ?? "20000",
  GOOGLE_OAUTH_CLIENT_ID: process.env.GOOGLE_OAUTH_CLIENT_ID ?? "",
  GOOGLE_OAUTH_CLIENT_SECRET: process.env.GOOGLE_OAUTH_CLIENT_SECRET ?? "",
  GOOGLE_OAUTH_REDIRECT_URI: process.env.GOOGLE_OAUTH_REDIRECT_URI ?? "http://localhost:3000/api/google/oauth/callback",
  ...
  SEO_POSITION_WARNING_THRESHOLD: process.env.SEO_POSITION_WARNING_THRESHOLD ?? "20",
  SEO_CTR_LOW_THRESHOLD: process.env.SEO_CTR_LOW_THRESHOLD ?? "0.02",
  SEO_HIGH_IMPRESSION_THRESHOLD: process.env.SEO_HIGH_IMPRESSION_THRESHOLD ?? "1000",
  GOOGLE_API_REAL_CONNECTION_ENABLED: process.env.GOOGLE_API_REAL_CONNECTION_ENABLED ?? "false",
  GOOGLE_OAUTH_SCOPES:
  ...
  GA4_ABSOLUTE_MAX_ROWS_PER_REQUEST: process.env.GA4_ABSOLUTE_MAX_ROWS_PER_REQUEST ?? "250000",
  GA4_RETURN_PROPERTY_QUOTA: process.env.GA4_RETURN_PROPERTY_QUOTA ?? "true",
  GOOGLE_SEARCH_CONSOLE_SYNC_ENABLED: process.env.GOOGLE_SEARCH_CONSOLE_SYNC_ENABLED ?? "false",
  GOOGLE_SEARCH_CONSOLE_DEFAULT_SYNC_DAYS: process.env.GOOGLE_SEARCH_CONSOLE_DEFAULT_SYNC_DAYS ?? "28",
  GOOGLE_SEARCH_CONSOLE_MAX_SYNC_DAYS: process.env.GOOGLE_SEARCH_CONSOLE_MAX_SYNC_DAYS ?? "90",
  GOOGLE_SEARCH_CONSOLE_ROW_LIMIT: process.env.GOOGLE_SEARCH_CONSOLE_ROW_LIMIT ?? "25000",
  GOOGLE_SEARCH_CONSOLE_MAX_PAGES_PER_SYNC: process.env.GOOGLE_SEARCH_CONSOLE_MAX_PAGES_PER_SYNC ?? "10",
  ...
  GOOGLE_API_RETRY_BASE_DELAY_MS: process.env.GOOGLE_API_RETRY_BASE_DELAY_MS ?? "2000",
  GOOGLE_API_SYNC_LOCK_MINUTES: process.env.GOOGLE_API_SYNC_LOCK_MINUTES ?? "15",
  GOOGLE_API_LOG_PAYLOAD: process.env.GOOGLE_API_LOG_PAYLOAD ?? "false",
  GOOGLE_API_LOG_RESPONSE_SUMMARY: process.env.GOOGLE_API_LOG_RESPONSE_SUMMARY ?? "true",
  OPERATIONS_AUTOMATION_ENABLED: process.env.OPERATIONS_AUTOMATION_ENABLED ?? "false",
  ...
  SYNC_WORKER_INTERVAL_SECONDS: process.env.SYNC_WORKER_INTERVAL_SECONDS ?? "60",
  ...
  SYNC_LEASE_HEARTBEAT_SECONDS: process.env.SYNC_LEASE_HEARTBEAT_SECONDS ?? "30",
  SYNC_MAX_RETRY_ATTEMPTS: process.env.SYNC_MAX_RETRY_ATTEMPTS ?? "2",
  SYNC_RETRY_BASE_DELAY_SECONDS: process.env.SYNC_RETRY_BASE_DELAY_SECONDS ?? "300",
  ...
  GA4_SCHEDULED_SYNC_DEFAULT_DAYS: process.env.GA4_SCHEDULED_SYNC_DEFAULT_DAYS ?? "7",
  GA4_MIN_QUOTA_REMAINING_TOKENS: process.env.GA4_MIN_QUOTA_REMAINING_TOKENS ?? "100",
  ...
  GSC_SCHEDULED_SYNC_DEFAULT_DAYS: process.env.GSC_SCHEDULED_SYNC_DEFAULT_DAYS ?? "7",
  GSC_QUERY_PAGE_SYNC_ENABLED: process.env.GSC_QUERY_PAGE_SYNC_ENABLED ?? "false",
  GROWTH_SCORE_AUTO_RECALC_ENABLED: process.env.GROWTH_SCORE_AUTO_RECALC_ENABLED ?? "false",
  ...
  ALERT_DEFAULT_COOLDOWN_HOURS: process.env.ALERT_DEFAULT_COOLDOWN_HOURS ?? "24",
  DATA_FRESHNESS_WARNING_HOURS: process.env.DATA_FRESHNESS_WARNING_HOURS ?? "48",
  DATA_FRESHNESS_CRITICAL_HOURS: process.env.DATA_FRESHNESS_CRITICAL_HOURS ?? "96",
  SEO_CLICKS_DROP_THRESHOLD_PERCENT: process.env.SEO_CLICKS_DROP_THRESHOLD_PERCENT ?? "30",
  SEO_IMPRESSIONS_DROP_THRESHOLD_PERCENT: process.env.SEO_IMPRESSIONS_DROP_THRESHOLD_PERCENT ?? "30",
  REVENUE_DROP_THRESHOLD_PERCENT: process.env.REVENUE_DROP_THRESHOLD_PERCENT ?? "40",
  SOCIAL_IMPRESSIONS_DROP_THRESHOLD_PERCENT: process.env.SOCIAL_IMPRESSIONS_DROP_THRESHOLD_PERCENT ?? "40",
  API_ERROR_SPIKE_THRESHOLD: process.env.API_ERROR_SPIKE_THRESHOLD ?? "5",
  NOTIFICATION_CENTER_ENABLED: process.env.NOTIFICATION_CENTER_ENABLED ?? "true",
  ...
  ARTICLE_IMPROVEMENT_ENABLED: process.env.ARTICLE_IMPROVEMENT_ENABLED ?? "true",
  ARTICLE_IMPROVEMENT_MOCK_MODE: process.env.ARTICLE_IMPROVEMENT_MOCK_MODE ?? "true",
  ...
  REWRITE_REQUIRE_HUMAN_APPROVAL: process.env.REWRITE_REQUIRE_HUMAN_APPROVAL ?? "true",
  REWRITE_REQUIRE_REAPPROVAL_ON_CHANGE: process.env.REWRITE_REQUIRE_REAPPROVAL_ON_CHANGE ?? "true",
  WORDPRESS_REWRITE_DRAFT_UPDATE_ENABLED: process.env.WORDPRESS_REWRITE_DRAFT_UPDATE_ENABLED ?? "false",
  WORDPRESS_PUBLISHED_POST_DIRECT_UPDATE_ENABLED: process.env.WORDPRESS_PUBLISHED_POST_DIRECT_UPDATE_ENABLED ?? "false",
  WORDPRESS_REWRITE_CREATE_NEW_DRAFT_ENABLED: process.env.WORDPRESS_REWRITE_CREATE_NEW_DRAFT_ENABLED ?? "true",
  WORDPRESS_REWRITE_UPDATE_EXISTING_DRAFT_ENABLED: process.env.WORDPRESS_REWRITE_UPDATE_EXISTING_DRAFT_ENABLED ?? "true",
  WORDPRESS_REWRITE_DEFAULT_MODE: process.env.WORDPRESS_REWRITE_DEFAULT_MODE ?? "create_new_draft",
  WORDPRESS_REWRITE_REQUEST_TIMEOUT_MS: process.env.WORDPRESS_REWRITE_REQUEST_TIMEOUT_MS ?? "20000",
  WORDPRESS_REWRITE_REQUIRE_MODIFIED_CHECK: process.env.WORDPRESS_REWRITE_REQUIRE_MODIFIED_CHECK ?? "true",
  CONTENT_DIFF_ENABLED: process.env.CONTENT_DIFF_ENABLED ?? "true",
  CONTENT_DIFF_MAX_CONTENT_LENGTH: process.env.CONTENT_DIFF_MAX_CONTENT_LENGTH ?? "120000",
  CONTENT_SNAPSHOT_ENABLED: process.env.CONTENT_SNAPSHOT_ENABLED ?? "true",
  CONTENT_SANITIZE_HTML_ENABLED: process.env.CONTENT_SANITIZE_HTML_ENABLED ?? "true",
  CONTENT_BLOCK_STRUCTURE_WARNING_ENABLED: process.env.CONTENT_BLOCK_STRUCTURE_WARNING_ENABLED ?? "true",
  SEO_IMPACT_MEASUREMENT_ENABLED: process.env.SEO_IMPACT_MEASUREMENT_ENABLED ?? "true",
  SEO_IMPACT_DEFAULT_DAYS_BEFORE: process.env.SEO_IMPACT_DEFAULT_DAYS_BEFORE ?? "28",
  SEO_IMPACT_DEFAULT_DAYS_AFTER: process.env.SEO_IMPACT_DEFAULT_DAYS_AFTER ?? "28",
  ...
  IMPROVEMENT_TASK_AUTO_CREATE_ENABLED: process.env.IMPROVEMENT_TASK_AUTO_CREATE_ENABLED ?? "false",
  IMPROVEMENT_TASK_REQUIRE_APPROVAL: process.env.IMPROVEMENT_TASK_REQUIRE_APPROVAL ?? "true",
  REWRITE_RISK_CHECK_ENABLED: process.env.REWRITE_RISK_CHECK_ENABLED ?? "true",
  REWRITE_HIGH_RISK_KEYWORDS_ENABLED: process.env.REWRITE_HIGH_RISK_KEYWORDS_ENABLED ?? "true",
  REWRITE_CRITICAL_RISK_BLOCKS_WORDPRESS_UPDATE: process.env.REWRITE_CRITICAL_RISK_BLOCKS_WORDPRESS_UPDATE ?? "true",
  ...
  SNS_PREVENT_DIRECT_AFFILIATE_LINK: process.env.SNS_PREVENT_DIRECT_AFFILIATE_LINK ?? "true",
  SNS_MANUAL_REVIEW_ON_UNKNOWN_STATUS: process.env.SNS_MANUAL_REVIEW_ON_UNKNOWN_STATUS ?? "true",
  SNS_POST_WORKER_ENABLED: process.env.SNS_POST_WORKER_ENABLED ?? "false",
  SNS_POST_WORKER_INTERVAL_SECONDS: process.env.SNS_POST_WORKER_INTERVAL_SECONDS ?? "60",
  ...
  SNS_RETRY_BASE_DELAY_SECONDS: process.env.SNS_RETRY_BASE_DELAY_SECONDS ?? "300",
  SNS_PERFORMANCE_SYNC_ENABLED: process.env.SNS_PERFORMANCE_SYNC_ENABLED ?? "false",
  ...
  X_OAUTH_REDIRECT_URI: process.env.X_OAUTH_REDIRECT_URI ?? "http://127.0.0.1:3000/api/x/oauth/callback",
  X_TOKEN_ENCRYPTION_KEY: process.env.X_TOKEN_ENCRYPTION_KEY ?? "",
  X_OAUTH_SCOPES: process.env.X_OAUTH_SCOPES ?? "tweet.read tweet.write users.read offline.access media.write",
  X_MEDIA_SIMPLE_UPLOAD_ENABLED: process.env.X_MEDIA_SIMPLE_UPLOAD_ENABLED ?? "true",
  X_MEDIA_CHUNKED_UPLOAD_ENABLED: process.env.X_MEDIA_CHUNKED_UPLOAD_ENABLED ?? "false",
  X_MEDIA_ALLOWED_IMAGE_TYPES: process.env.X_MEDIA_ALLOWED_IMAGE_TYPES ?? "image/jpeg,image/png,image/gif,image/webp",
  X_POST_DEFAULT_MADE_WITH_AI: process.env.X_POST_DEFAULT_MADE_WITH_AI ?? "false",
  X_POST_PAID_PARTNERSHIP_ENABLED: process.env.X_POST_PAID_PARTNERSHIP_ENABLED ?? "false",
  X_RATE_LIMIT_STOP_ON_429: process.env.X_RATE_LIMIT_STOP_ON_429 ?? "true",
  CAMPAIGN_MANAGEMENT_ENABLED: process.env.CAMPAIGN_MANAGEMENT_ENABLED ?? "true",
  CAMPAIGN_MANAGEMENT_MOCK_MODE: process.env.CAMPAIGN_MANAGEMENT_MOCK_MODE ?? "true",
  CONTENT_CALENDAR_ADVANCED_ENABLED: process.env.CONTENT_CALENDAR_ADVANCED_ENABLED ?? "true",
  CONTENT_CALENDAR_MOCK_MODE: process.env.CONTENT_CALENDAR_MOCK_MODE ?? "true",
  CONTENT_CALENDAR_CONFLICT_DETECTION_ENABLED: process.env.CONTENT_CALENDAR_CONFLICT_DETECTION_ENABLED ?? "true",
  CONTENT_CALENDAR_MAX_SOCIAL_POSTS_PER_DAY: process.env.CONTENT_CALENDAR_MAX_SOCIAL_POSTS_PER_DAY ?? "3",
  CONTENT_CALENDAR_MAX_CAMPAIGNS_OVERLAP: process.env.CONTENT_CALENDAR_MAX_CAMPAIGNS_OVERLAP ?? "3",
  CAMPAIGN_ROI_ENABLED: process.env.CAMPAIGN_ROI_ENABLED ?? "true",
  CAMPAIGN_ROI_DEFAULT_PERIOD_DAYS: process.env.CAMPAIGN_ROI_DEFAULT_PERIOD_DAYS ?? "28",
  CAMPAIGN_ROI_MIN_DATA_DAYS: process.env.CAMPAIGN_ROI_MIN_DATA_DAYS ?? "7",
  CAMPAIGN_ROI_DEFAULT_CURRENCY: process.env.CAMPAIGN_ROI_DEFAULT_CURRENCY ?? "JPY",
  CAMPAIGN_ROI_REQUIRE_APPROVED_REVENUE_VIEW: process.env.CAMPAIGN_ROI_REQUIRE_APPROVED_REVENUE_VIEW ?? "true",
  CAMPAIGN_ROI_ALLOW_PENDING_VIEW: process.env.CAMPAIGN_ROI_ALLOW_PENDING_VIEW ?? "true",
  CAMPAIGN_ROI_PREVENT_DOUBLE_COUNT: process.env.CAMPAIGN_ROI_PREVENT_DOUBLE_COUNT ?? "true",
  CAMPAIGN_ATTRIBUTION_ENABLED: process.env.CAMPAIGN_ATTRIBUTION_ENABLED ?? "true",
  CAMPAIGN_ATTRIBUTION_DEFAULT_METHOD: process.env.CAMPAIGN_ATTRIBUTION_DEFAULT_METHOD ?? "direct",
  CAMPAIGN_ATTRIBUTION_ALLOW_ALLOCATION_RATE: process.env.CAMPAIGN_ATTRIBUTION_ALLOW_ALLOCATION_RATE ?? "true",
  CAMPAIGN_GROWTH_SCORE_ENABLED: process.env.CAMPAIGN_GROWTH_SCORE_ENABLED ?? "true",
  CAMPAIGN_RECOMMENDATION_ENABLED: process.env.CAMPAIGN_RECOMMENDATION_ENABLED ?? "true",
  CAMPAIGN_REQUIRE_HUMAN_REVIEW: process.env.CAMPAIGN_REQUIRE_HUMAN_REVIEW ?? "true",
  REPORT_GENERATION_ENABLED: process.env.REPORT_GENERATION_ENABLED ?? "true",
  REPORT_GENERATION_MOCK_MODE: process.env.REPORT_GENERATION_MOCK_MODE ?? "true",
  REPORT_AUTO_GENERATION_ENABLED: process.env.REPORT_AUTO_GENERATION_ENABLED ?? "false",
  REPORT_DEFAULT_PERIOD: process.env.REPORT_DEFAULT_PERIOD ?? "weekly",
  REPORT_REQUIRE_HUMAN_REVIEW: process.env.REPORT_REQUIRE_HUMAN_REVIEW ?? "true",
  ...
  REPORT_EXPORT_FORMATS: process.env.REPORT_EXPORT_FORMATS ?? "markdown,csv,json",
  REPORT_EXTERNAL_SEND_ENABLED: process.env.REPORT_EXTERNAL_SEND_ENABLED ?? "false",
  CAMPAIGN_ALERTS_ENABLED: process.env.CAMPAIGN_ALERTS_ENABLED ?? "true",
  CAMPAIGN_RISK_CHECK_ENABLED: process.env.CAMPAIGN_RISK_CHECK_ENABLED ?? "true",
  CAMPAIGN_COST_TRACKING_ENABLED: process.env.CAMPAIGN_COST_TRACKING_ENABLED ?? "true",
  CAMPAIGN_WORKLOAD_TRACKING_ENABLED: process.env.CAMPAIGN_WORKLOAD_TRACKING_ENABLED ?? "true",
  BUSINESS_INSIGHT_ENABLED: process.env.BUSINESS_INSIGHT_ENABLED ?? "true",
  BUSINESS_INSIGHT_REQUIRE_HUMAN_REVIEW: process.env.BUSINESS_INSIGHT_REQUIRE_HUMAN_REVIEW ?? "true"
};
...
async function seedMockImage(filename: string, title: string, width: number, height: number) {
...
async function seedPhase4() {
  const networkSeeds = [
    ...
    { name: "ValueCommerce", slug: "valuecommerce", websiteUrl: "https://www.valuecommerce.ne.jp/" },
    { name: "AccessTrade", slug: "accesstrade", websiteUrl: "https://www.accesstrade.ne.jp/" }
  ];
  ...
  const a8 = networks.find((network) => network.slug === "a8-net") ?? networks[0];
  ...
  const programSeeds = [
    { id: "seed-program-ai-tools", network: a8, programName: "AI tools comparison program", genre: "AI", rewardAmount: 1800, riskLevel: AffiliateRiskLevel.MEDIUM },
    { id: "seed-program-gadget-ec", network: a8, programName: "Gadget EC program", genre: "Gadget", rewardAmount: 900, riskLevel: AffiliateRiskLevel.LOW },
    { id: "seed-program-pet-food", network: afb, programName: "Pet food subscription program", genre: "Pet", rewardAmount: 2400, riskLevel: AffiliateRiskLevel.MEDIUM },
    { id: "seed-program-minimal-service", network: a8, programName: "Minimal life service program", genre: "Lifestyle", rewardAmount: 1200, riskLevel: AffiliateRiskLevel.LOW }
  ];
    ...
    programs.push(
      await prisma.affiliateProgram.upsert({
        ...
        create: {
          ...
          complianceNotes: "Use affiliate links inside WordPress only. X must link to WordPress articles.",
          riskLevel: programSeed.riskLevel,
          status: AffiliateProgramStatus.APPROVED
        }
      })
  ...
  for (const [index, mediaItem] of media.entries()) {
    ...
    const wpPost = await prisma.wordPressPost.findFirst({ where: { mediaId: mediaItem.id } });
    if (wpPost) {
    ...
    for (let count = 0; count < approvedCount + pendingCount + rejectedCount; count += 1) {
      const status =
        count < approvedCount
    ...
    await prisma.growthScoreSnapshot.upsert({
      ...
      create: {
        ...
        recommendation: index === 0 ? GrowthRecommendationType.IMPROVE : GrowthRecommendationType.MAINTAIN,
        dataConfidence: DataConfidence.MEDIUM,
...
async function seedPhase5() {
  ...
  for (const [index, mediaItem] of media.entries()) {
    ...
    const ga4Property = await prisma.gA4Property.upsert({
      where: { mediaId_propertyId: { mediaId: mediaItem.id, propertyId: `properties/${900000 + index}` } },
      update: {
    ...
    const searchConsoleProperty = await prisma.searchConsoleProperty.upsert({
      where: { mediaId_siteUrl: { mediaId: mediaItem.id, siteUrl: mediaItem.wordpressUrl } },
      update: {
        googleConnectionId: connection.id,
        connectionStatus: GooglePropertyStatus.MOCK_CONNECTED,
        mockMode: true
    ...
    const wpPost =
      (await prisma.wordPressPost.findFirst({ where: { mediaId: mediaItem.id }, orderBy: { createdAt: "asc" } })) ??
      null;
    const pagePath = wpPost ? `/${wpPost.slug}/` : "/";
    const pageUrl = wpPost?.wordpressPostUrl ?? `${mediaItem.wordpressUrl.replace(/\/$/, "")}${pagePath}`;
    ...
    const keyword = await prisma.seoKeyword.upsert({
      where: { mediaId_normalizedKeyword: { mediaId: mediaItem.id, normalizedKeyword } },
      update: {
        keyword: query,
        priority: 80 - index * 5,
    ...
    if (wpPost) {
      await prisma.seoPageKeyword.upsert({
        where: { wordpressPostId_seoKeywordId: { wordpressPostId: wpPost.id, seoKeywordId: keyword.id } },
        update: {
    ...
    for (let day = 0; day < 28; day += 1) {
      ...
      const clicks = Math.max(1, Math.round(impressions * (0.018 + index * 0.004)));
      ...
      await prisma.gA4MetricDaily.upsert({
        where: { mediaId_ga4PropertyId_date_source: { mediaId: mediaItem.id, ga4PropertyId: ga4Property.id, date, source: SeoDataSource.MOCK } },
        update: {
          sessions,
      ...
      await prisma.searchConsoleQueryDaily.upsert({
        ...
        update: { clicks, impressions, ctr: clicks / impressions, position: 11 + index + day / 50 },
        create: {
    ...
    const opportunity = await prisma.seoOpportunity.upsert({
      ...
      create: {
        ...
        description: "Search Console mock data shows impressions are high, but CTR is still low.",
        evidence: { query, totalClicks, totalImpressions, ctr: totalClicks / totalImpressions },
        expectedImpact: "Higher CTR and more WordPress sessions after human-reviewed edits.",
        status: SeoOpportunityStatus.NEW,
        opportunityScore: 82 - index * 4
      }
    });
    ...
    await prisma.seoRecommendation.upsert({
      ...
      create: {
        ...
        description: "Adjust the title so it answers the commercial search intent more directly.",
        ...
        reason: "Mock Search Console data indicates high impressions with low CTR.",
        requiresHumanReview: true,
        approvalStatus: SeoApprovalStatus.PENDING_APPROVAL
      }
    });
    ...
    await prisma.seoAnalysisSnapshot.upsert({
      ...
      create: {
        ...
        organicSessions: totalSessions,
        topQueries: [{ query, clicks: totalClicks, impressions: totalImpressions }],
        topPages: [{ pageUrl, sessions: totalSessions }],
        opportunityCount: 1,
        dataConfidence: DataConfidence.MEDIUM,
        summary: "Seeded Phase 5 mock SEO snapshot. Human review is required before applying recommendations."
      }
    });
    ...
    await prisma.googleApiErrorLog.upsert({
      ...
      create: {
        ...
        errorMessage: "Seed note: real Google API connection is disabled by default.",
        retryable: false,
...
async function seedPhase7() {
  for (const [key, value] of Object.entries(defaultSettings).filter(([key]) =>
    ...
    await prisma.operationSetting.upsert({
      where: { key },
      update: { value, valueType: value === "true" || value === "false" ? OperationSettingValueType.BOOLEAN : Number.isFinite(Number(value)) ? OperationSettingValueType.NUMBER : OperationSettingValueType.STRING },
      create: {
        key,
        value,
        valueType: value === "true" || value === "false" ? OperationSettingValueType.BOOLEAN : Number.isFinite(Number(value)) ? OperationSettingValueType.NUMBER : OperationSettingValueType.STRING,
  ...
  const taskSeeds = [
    ["ga4-daily-sync", "GA4 Daily Sync", ScheduledTaskType.GA4_SYNC, defaultSettings.GA4_SCHEDULED_SYNC_CRON, false, true],
    ["gsc-query-daily-sync", "GSC Query Daily Sync", ScheduledTaskType.GSC_QUERY_SYNC, defaultSettings.GSC_SCHEDULED_SYNC_CRON, false, true],
    ["gsc-page-daily-sync", "GSC Page Daily Sync", ScheduledTaskType.GSC_PAGE_SYNC, "35 3 * * *", false, true],
    ["gsc-query-page-daily-sync", "GSC Query Page Daily Sync", ScheduledTaskType.GSC_QUERY_PAGE_SYNC, "40 3 * * *", false, true],
    ["data-freshness-check", "Data Freshness Check", ScheduledTaskType.DATA_FRESHNESS_CHECK, "0 6 * * *", true, false],
    ["seo-drop-detection", "SEO Drop Detection", ScheduledTaskType.SEO_DROP_DETECTION, defaultSettings.ALERT_DETECTION_CRON, true, false],
    ["revenue-drop-detection", "Revenue Drop Detection", ScheduledTaskType.REVENUE_DROP_DETECTION, "10 6 * * *", true, false],
    ["social-drop-detection", "Social Drop Detection", ScheduledTaskType.SOCIAL_DROP_DETECTION, "20 6 * * *", true, false],
    ["api-error-spike", "API Error Spike", ScheduledTaskType.API_ERROR_SPIKE, "30 6 * * *", true, false],
    ["growth-score-recalc", "Growth Score Recalc", ScheduledTaskType.GROWTH_SCORE_RECALC, defaultSettings.GROWTH_SCORE_RECALC_CRON, false, true],
    ["gsb-weekly-report", "GSB Weekly Report", ScheduledTaskType.GSB_WEEKLY_REPORT, defaultSettings.GSB_WEEKLY_REPORT_CRON, false, true],
    ["operations-health-check", "Health Check", ScheduledTaskType.HEALTH_CHECK, "*/30 * * * *", true, false]
  ] as const;

  const nextRunAt = new Date(Date.now() + 60 * 60 * 1000);
  for (const [taskKey, taskName, taskType, cronExpression, enabled, dryRun] of taskSeeds) {
    await prisma.scheduledTask.upsert({
      ...
      update: {
        ...
        enabled,
        dryRun,
        status: enabled ? ScheduledTaskStatus.ACTIVE : ScheduledTaskStatus.DISABLED,
        nextRunAt
      },
      create: {
        taskKey,
  ...
  const channels = [
    ["in-app", "In-app notification center", NotificationChannelType.IN_APP, NotificationChannelStatus.ENABLED, true],
    ["mock-outbox", "Mock outbox", NotificationChannelType.MOCK, NotificationChannelStatus.ENABLED, true],
    ["email-disabled", "Email notification disabled", NotificationChannelType.EMAIL, NotificationChannelStatus.DISABLED, true],
    ["slack-disabled", "Slack notification disabled", NotificationChannelType.SLACK, NotificationChannelStatus.DISABLED, true]
  ] as const;
  ...
  const alertRules = [
    ["data-freshness", "Data freshness warning", "DATA_FRESHNESS", "WARNING", null],
    ["api-error-spike", "API error spike", "API_ERROR_SPIKE", "CRITICAL", Number(defaultSettings.API_ERROR_SPIKE_THRESHOLD)],
    ["sync-failure", "Scheduled sync failure", "SYNC_FAILURE", "WARNING", null],
    ["seo-clicks-drop", "SEO clicks drop", "SEO_CLICKS_DROP", "WARNING", Number(defaultSettings.SEO_CLICKS_DROP_THRESHOLD_PERCENT)],
    ["seo-impressions-drop", "SEO impressions drop", "SEO_IMPRESSIONS_DROP", "WARNING", Number(defaultSettings.SEO_IMPRESSIONS_DROP_THRESHOLD_PERCENT)],
    ["revenue-drop", "Revenue drop", "REVENUE_DROP", "CRITICAL", Number(defaultSettings.REVENUE_DROP_THRESHOLD_PERCENT)],
    ["social-drop", "Social impressions drop", "SOCIAL_IMPRESSIONS_DROP", "WARNING", Number(defaultSettings.SOCIAL_IMPRESSIONS_DROP_THRESHOLD_PERCENT)]
  ] as const;
  for (const [ruleKey, ruleName, ruleType, severity, thresholdValue] of alertRules) {
    await prisma.alertRule.upsert({
      where: { ruleKey },
      update: { ruleName, ruleType, severity, thresholdValue, enabled: true },
      create: { ruleKey, ruleName, ruleType, severity, thresholdValue, enabled: true }
    });
  }
  ...
  await prisma.operationsHealthSnapshot.create({
    data: {
      status: "HEALTHY",
      summary: "Phase 7 seed health snapshot. Automation is disabled by default.",
...
async function seedPhase8() {
  ...
  for (const [index, mediaItem] of media.entries()) {
    const wpPost = await prisma.wordPressPost.findFirst({ where: { mediaId: mediaItem.id }, orderBy: { createdAt: "asc" } });
    const seoRecommendation = await prisma.seoRecommendation.findFirst({ where: { mediaId: mediaItem.id }, orderBy: { createdAt: "asc" } });
    const growthRecommendation = await prisma.growthRecommendation.findFirst({ where: { mediaId: mediaItem.id }, orderBy: { createdAt: "asc" } });
    const title =
      index === 0
    ...
    const task = await prisma.articleImprovementTask.upsert({
      ...
      update: {
        taskTitle: title,
        wordpressPostId: wpPost?.id,
        status: index === 3 ? ArticleImprovementStatus.MEASURING : ArticleImprovementStatus.PENDING_APPROVAL
      },
      create: {
        ...
        priority: index === 0 ? ArticleImprovementPriority.HIGH : index === 3 ? ArticleImprovementPriority.MONITOR : ArticleImprovementPriority.MEDIUM,
        status: index === 3 ? ArticleImprovementStatus.MEASURING : ArticleImprovementStatus.PENDING_APPROVAL,
        sourceType: seoRecommendation ? ImprovementSourceType.SEO_RECOMMENDATION : ImprovementSourceType.MANUAL,
        ...
        expectedImpact: "Improve SEO clarity, reader action, and measurable article performance."
      }
    });
    ...
    const safeHtml = wpPost.contentHtml.replace(/<script[\s\S]*?<\/script>/gi, "");
    ...
    const draft = await prisma.rewriteDraft.upsert({
      ...
      create: {
        ...
        summary: "Seed mock rewrite draft. Human approval is required before WordPress draft update."
      }
    });
    ...
    const riskStatus = index === 1 ? RewriteRiskCheckStatus.WARNING : RewriteRiskCheckStatus.PASSED;
    await prisma.rewriteRiskCheck.upsert({
      ...
      create: {
        ...
        rewriteDraftId: draft.id,
        status: riskStatus,
        maxRiskLevel: index === 1 ? RewriteRiskLevel.MEDIUM : RewriteRiskLevel.LOW,
        warningCount: index === 1 ? 1 : 0,
        findings: index === 1 ? [{ level: "MEDIUM", message: "Affiliate placement requires human review." }] : []
      }
    });

    const safetyStatus = index === 0 ? WordPressRewriteSafetyStatus.FAILED : WordPressRewriteSafetyStatus.PASSED;
    const safety = await prisma.wordPressRewriteSafetyCheck.upsert({
      ...
      create: {
        ...
        expectedVersion: 1,
        approvedVersion: null,
        reason: safetyStatus === WordPressRewriteSafetyStatus.FAILED ? "Seed: not approved yet, WordPress update blocked." : "Seed: mock update is allowed after approval."
      }
    });
    ...
    await prisma.wordPressDraftUpdate.upsert({
      ...
      create: {
        ...
        wordpressPostId: wpPost.id,
        updateMode: WordPressRewriteUpdateMode.CREATE_NEW_DRAFT,
        status: safetyStatus === WordPressRewriteSafetyStatus.FAILED ? WordPressDraftUpdateStatus.BLOCKED : WordPressDraftUpdateStatus.MOCK_UPDATED,
        mockMode: true,
    ...
    await prisma.seoImpactMeasurement.upsert({
      ...
      create: {
        ...
        mediaId: mediaItem.id,
        wordpressPostId: wpPost.id,
        status: index === 3 ? SeoImpactStatus.INSUFFICIENT_DATA : SeoImpactStatus.PENDING,
        ...
        dataConfidence: index === 3 ? DataConfidence.INSUFFICIENT : DataConfidence.LOW,
        summary: index === 3 ? "Seed measurement is protected because data is insufficient." : "Seed impact measurement placeholder."
      }
    });
...
async function seedPhase9() {
  ...
  for (const [index, account] of socialAccounts.entries()) {
    ...
    const wordpressPost = await prisma.wordPressPost.findFirst({ where: { mediaId: account.mediaId } });
    const creativeAsset = await prisma.creativeAsset.findFirst({ where: { mediaId: account.mediaId } });
    ...
    const linkUrl = isBlockedSeed ? "https://px.a8.net/example" : account.media.wordpressUrl;
    const queue = await prisma.socialPostQueue.upsert({
      ...
      create: {
        ...
        socialApiConnectionId: connection.id,
        platform: Platform.X,
        sourceType: wordpressPost ? SocialPostSourceType.WORDPRESS_POST : SocialPostSourceType.MANUAL,
        ...
        approvalStatus: isBlockedSeed ? SocialPostApprovalStatus.PENDING : SocialPostApprovalStatus.APPROVED,
        linkCheckStatus: isBlockedSeed ? SocialPostCheckStatus.BLOCKED : SocialPostCheckStatus.PASSED,
        riskCheckStatus: isBlockedSeed ? SocialPostCheckStatus.BLOCKED : SocialPostCheckStatus.PASSED,
        dedupCheckStatus: SocialPostCheckStatus.PASSED,
        rateLimitStatus: SocialRateLimitStatus.OK,
        manualReviewStatus: isBlockedSeed ? SocialManualReviewStatus.OPEN : null,
        ...
        platformPostUrl: isPostedSeed ? `https://x.com/mock/status/mock-x-seed-${index}` : null,
        postedAt: isPostedSeed ? new Date(Date.now() - 24 * 60 * 60 * 1000) : null,
        madeWithAi: false,
        paidPartnership: false,
        utmCampaign: "growth_lab_phase9",
        failureReason: isBlockedSeed ? "Direct affiliate links are blocked for X." : null
      }
    });
    ...
    await prisma.socialPostSafetyCheck.upsert({
      ...
      create: {
        ...
        status: isBlockedSeed ? SocialPostCheckStatus.BLOCKED : SocialPostCheckStatus.PASSED,
        linkCheckStatus: isBlockedSeed ? SocialPostCheckStatus.BLOCKED : SocialPostCheckStatus.PASSED,
        riskCheckStatus: isBlockedSeed ? SocialPostCheckStatus.BLOCKED : SocialPostCheckStatus.PASSED,
        dedupCheckStatus: SocialPostCheckStatus.PASSED,
        rateLimitStatus: SocialRateLimitStatus.OK,
        ...
        reasons: isBlockedSeed ? ["Direct affiliate links are blocked for X posts."] : ["Seed safety gate passed."]
      }
    });
    ...
    await prisma.socialMediaUpload.upsert({
      ...
      create: {
        ...
        creativeAssetId: creativeAsset?.id,
        platform: Platform.X,
        uploadStatus: creativeAsset ? SocialMediaUploadStatus.MOCK_UPLOADED : SocialMediaUploadStatus.QUEUED,
    ...
    await prisma.socialImprovementSuggestion.upsert({
      ...
      create: {
        ...
        socialAccountId: account.id,
        socialPostQueueId: queue.id,
        suggestionType: isBlockedSeed ? SocialImprovementSuggestionType.LINK_TO_UPDATED_ARTICLE : SocialImprovementSuggestionType.IMPROVE_CTA,
        priority: isBlockedSeed ? 10 : 40,
        title: isBlockedSeed ? "Replace direct affiliate URL with WordPress article URL" : "Improve social CTA",
    ...
    await prisma.socialGrowthScoreSnapshot.upsert({
      ...
      create: {
        ...
        recommendation: "Improve hooks and keep human approval. Do not increase posting automatically.",
        dataConfidence: DataConfidence.INSUFFICIENT,
...
async function seedPhase10() {
  ...
  for (const [index, media] of mediaList.entries()) {
    ...
    const campaign = await prisma.campaign.upsert({
      ...
      create: {
        ...
        campaignType: index === 0 ? CampaignType.SEO_GROWTH : index === 1 ? CampaignType.CONVERSION_IMPROVEMENT : index === 2 ? CampaignType.CONTENT_REFRESH : CampaignType.SNS_GROWTH,
        status: index === 3 ? CampaignStatus.ACTIVE : CampaignStatus.PLANNING,
        periodStart,
        periodEnd,
        owner: "local-admin",
        description: "Seeded Phase 10 cross-channel campaign.",
        primaryGoal: "Improve revenue, traffic, and campaign-level ROI without automatic budget changes.",
    ...
    await prisma.campaignObjective.upsert({
      ...
      create: {
        ...
        objectiveType: index === 0 ? CampaignObjectiveType.SEARCH_CLICKS : CampaignObjectiveType.APPROVED_REVENUE,
        objectiveName: index === 0 ? "Search clicks growth" : "Approved revenue growth",
    ...
    await prisma.campaignTarget.upsert({
      where: { campaignId_targetType_targetValue: { campaignId: campaign.id, targetType: CampaignTargetType.NICHE, targetValue: media.niche } },
      update: {},
      create: {
        campaignId: campaign.id,
    ...
    const wordpressPost = await prisma.wordPressPost.findFirst({ where: { mediaId: media.id } });
    const socialQueue = await prisma.socialPostQueue.findFirst({ where: { mediaId: media.id } });
    const creativeAsset = await prisma.creativeAsset.findFirst({ where: { mediaId: media.id } });
    const revenueEvent = await prisma.revenueEvent.findFirst({ where: { mediaId: media.id } });

    const items = [
      wordpressPost && { id: wordpressPost.id, type: CampaignItemType.WORDPRESS_POST, title: wordpressPost.title },
      socialQueue && { id: socialQueue.id, type: CampaignItemType.SOCIAL_POST_QUEUE, title: socialQueue.postText.slice(0, 60) },
      creativeAsset && { id: creativeAsset.id, type: CampaignItemType.CREATIVE_ASSET, title: creativeAsset.title },
      revenueEvent && { id: revenueEvent.id, type: CampaignItemType.REVENUE_EVENT, title: "Revenue event attribution source" }
    ].filter(Boolean) as Array<{ id: string; type: CampaignItemType; title: string }>;

    for (const item of items) {
      await prisma.campaignItem.upsert({
        where: { campaignId_itemType_itemId: { campaignId: campaign.id, itemType: item.type, itemId: item.id } },
        update: {},
        create: {
          campaignId: campaign.id,
          itemType: item.type,
          ...
          allocationRate: item.type === CampaignItemType.REVENUE_EVENT ? 0.5 : 1,
          status: item.type === CampaignItemType.REVENUE_EVENT ? CampaignItemStatus.MEASURED : CampaignItemStatus.PLANNED,
    ...
    await prisma.campaignCost.upsert({
      ...
      create: {
        ...
        memo: index === 2 ? "Seed: missing actual cost creates low confidence." : "Seed Phase 10 actual cost."
      }
    });

    await prisma.campaignRevenueAttribution.upsert({
      where: { campaignId_sourceType_sourceId: { campaignId: campaign.id, sourceType: AttributionSourceType.MOCK, sourceId: `seed-revenue-${media.id}` } },
      update: {},
      create: {
        campaignId: campaign.id,
        mediaId: media.id,
        ...
        approvedRevenue: index === 1 ? 12000 : index === 2 ? 3000 : 16000 + index * 12000,
    ...
    const approvedRevenue = index === 1 ? 12000 : index === 2 ? 3000 : 16000 + index * 12000;
    ...
    await prisma.campaignRoiSnapshot.upsert({
      ...
      create: {
        ...
        dataConfidence: actualCost > 0 ? DataConfidence.LOW : DataConfidence.INSUFFICIENT,
        calculationKey: `seed-roi-${media.id}`,
        warnings: actualCost === 0 ? ["actual_cost_missing"] : index === 1 ? ["low_roi"] : []
      }
    });
    ...
    await prisma.campaignGrowthScoreSnapshot.upsert({
      ...
      create: {
        ...
        dataConfidence: DataConfidence.LOW,
        reasoning: "Seed campaign growth score is advisory and requires human review."
      }
    });
    ...
    await prisma.campaignRisk.upsert({
      ...
      create: {
        ...
        campaignId: campaign.id,
        riskType: index === 1 ? CampaignRiskType.LOW_ROI : index === 2 ? CampaignRiskType.DATA_INSUFFICIENT : CampaignRiskType.REPORT_OVERDUE,
        severity: index === 1 ? CampaignRiskSeverity.CRITICAL : CampaignRiskSeverity.WARNING,
        status: CampaignRiskStatus.OPEN,
        title: index === 1 ? "Low ROI requires review" : "Campaign needs review",
        description: "Seed Phase 10 risk. It does not pause or alter the campaign automatically."
      }
    });
    ...
    await prisma.campaignRecommendation.upsert({
      ...
      create: {
        ...
        campaignId: campaign.id,
        recommendationType: index === 1 ? CampaignRecommendationType.REVIEW_LOW_ROI : CampaignRecommendationType.IMPROVE_CTA,
        priority: index === 1 ? 10 : 40,
        title: index === 1 ? "Review low ROI campaign before continuing" : "Improve CTA and content alignment",
        description: "Seed recommendation requires human review before task conversion.",
    ...
    const calendarEvent = await prisma.contentCalendarEvent.upsert({
      ...
      create: {
        ...
        campaignId: campaign.id,
        mediaId: media.id,
        eventType: index === 3 ? CalendarEventType.SNS_POST : CalendarEventType.WORDPRESS_PUBLISH,
        ...
        itemType: wordpressPost ? CampaignItemType.WORDPRESS_POST : CampaignItemType.SOCIAL_POST_QUEUE,
    ...
    if (index !== 0) {
      await prisma.contentCalendarConflict.upsert({
        ...
        create: {
          ...
          conflictType: index === 2 ? CalendarConflictType.MISSING_CREATIVE : CalendarConflictType.MISSING_APPROVAL,
    ...
    await prisma.reportSection.upsert({
      where: { generatedReportId_sectionKey: { generatedReportId: report.id, sectionKey: "summary" } },
      update: {},
      create: {
    ...
    await prisma.reportExport.upsert({
      where: { generatedReportId_exportFormat: { generatedReportId: report.id, exportFormat: ReportExportFormat.MARKDOWN } },
      update: {},
      create: {
        generatedReportId: report.id,
    ...
    const insight = await prisma.businessInsight.upsert({
      ...
      create: {
        ...
        mediaId: media.id,
        campaignId: campaign.id,
        insightType: index === 1 ? BusinessInsightType.LOW_ROI_CAMPAIGN : index === 2 ? BusinessInsightType.PENDING_REVENUE_GAP : BusinessInsightType.GROWTH_OPPORTUNITY,
        status: BusinessInsightStatus.PROPOSED,
        priority: index === 1 ? 10 : 40,
        title: index === 1 ? "Low ROI campaign review" : "Campaign improvement opportunity",
        summary: "Seed business insight. Human review is required before action.",
        evidenceJson: { campaignCode: campaign.campaignCode },
        recommendation: "Convert to recommendation or task only after approval.",
        requiresHumanReview: true
      }
    });
  ...
  await prisma.apiUsageLog.upsert({
    ...
    create: {
      ...
      mockMode: true,
      message: "Phase 10 campaign, calendar, ROI, report, and insight seed created."
    }
  });
}
...
async function main() {
  ...
  for (const item of mediaSeeds) {
    ...
    const account = await prisma.socialAccount.upsert({
      where: { platform_handle: { platform: Platform.X, handle: `@${media.id.replace("seed-media-", "")}_x` } },
      update: {},
      create: {
        mediaId: media.id,
        platform: Platform.X,
    ...
    const existingPosts = await prisma.post.count({ where: { mediaId: media.id } });
    if (existingPosts === 0) {
    ...
    if (media.id === "seed-media-ai-side-business") {
      const site = await prisma.wordPressSite.upsert({
        where: { mediaId_siteUrl: { mediaId: media.id, siteUrl: "https://example.com" } },
        update: {
      ...
      await prisma.wordPressPost.upsert({
        ...
        create: {
          ...
          slug: "ai-sidejob-tools-for-beginners",
          excerpt: "AI副業を始めたい初心者向けに、ツール選びの基準を整理します。",
          contentMarkdown:
          ...
          seoDescription: "AI副業を始めたい初心者向けに、ツール選びの基準、注意点、比較ポイントを解説します。",
      ...
      await prisma.canvaBrandTemplate.upsert({
        ...
        create: {
          ...
          width: 1200,
          height: 630,
          autofillFields: { title: "TITLE", subtitle: "SUBTITLE", siteName: "SITE_NAME" },
      ...
      const fileInfo = await seedMockImage("seed-featured-ai-side-business.svg", "AI Tool Guide", 1200, 630);
