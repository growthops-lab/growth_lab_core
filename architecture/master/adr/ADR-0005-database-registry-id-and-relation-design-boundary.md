# ADR-0005: Database, Registry, ID, and Relation Design Boundary
Status: Accepted
Date: 2026-07-08
Owner: Human Owner
Reviewer: Human Owner / Codex Support
Source: P1_ADR_Candidate_Triage.md
Related Index IDs: ACI-CH03-007, ACI-CH04-006, ACI-CH05-007, ACI-CH05-008, ACI-CH05-009, ACI-CH06-007, ACI-CH07-012, ACI-CH08-001, ACI-CH08-005, ACI-CH08-006, ACI-CH08-007, ACI-CH08-008, ACI-CH08-009, ACI-CH08-010, ACI-CH08-011
Related Source Candidate IDs: ADR-0005, ADR-0022, ADR-0026, ADR-0036, ADR-0037, ADR-0038, ADR-0045, ADR-0057, ADR-0062, ADR-0063, ADR-0064, ADR-0065, ADR-0066, ADR-0067
Decision Type: Architecture Decision Record Draft
Target Phase: MVP / Phase 1 Implementation Preparation

---
## 1. Context
This ADR draft was selected from the First ADR Draft Wave because Database, Registry, ID, and Relation Design Boundary is likely to affect MVP and Phase 1 implementation preparation if left unresolved.
Related triage theme: Database, Registry, ID, and Relation Design Boundary.
Related source categories: AI Platform, Core System, Database, Mail Platform, SNS Platform, WordPress Platform.
...
For MVP, use registry-to-database migration boundaries that preserve conceptual registry ownership while implementing stable IDs, relations, and audit-ready records in PostgreSQL and Prisma-oriented implementation planning.
## 6. Rationale
