...
export function mockAutofillDesign(templateId: string): CanvaApiResult<CanvaMockDesign> {
...
export function mockExportDesign(designId: string): CanvaApiResult<CanvaMockExport> {
