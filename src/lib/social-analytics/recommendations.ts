import { SocialImprovementSuggestionStatus, SocialImprovementSuggestionType } from "@prisma/client";
...
export async function createSocialImprovementSuggestion(queueId: string) {
  ...
  return prisma.socialImprovementSuggestion.create({
    data: {
      ...
      description: "Create a human-reviewed variant with a stronger article benefit and a clearer CTA. Do not auto-post from this suggestion.",
